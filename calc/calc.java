...
public class calc extends JFrame
{
    ...
    private  AddButtonHandler7 abHandler7;
    ...
    public calc(){
        ...
        addB8=new JButton("Vid");
        abHandler7=new AddButtonHandler7();
        addB8.addActionListener(abHandler7);
    ...
    private class ExitButtonHandler implements ActionListener{
        ...
        private class AddButtonHandler7 implements ActionListener{
        public void actionPerformed(ActionEvent e){
            Runtime runtime = Runtime.getRuntime();   
         try
        {
            runtime.exec("Project3.exe");        
